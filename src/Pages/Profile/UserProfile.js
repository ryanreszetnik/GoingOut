...
import { acceptRequest, deleteFriend, requestFriend } from "../../Endpoints/friendsEndpoints"
import { MaterialCommunityIcons } from "@expo/vector-icons"
import { TouchableOpacity } from "react-native-gesture-handler"
import { ACCEPT_REQUEST, ADD_FRIEND, REMOVE_FRIEND, SET_CUR_PROFILE, SET_OTHER_FRIENDS } from "../../Actions/friendActions"
...
// navigation.navigate("Friends");
  ...
  const getButtons = ()=>{
    switch(profile.status){
      case REQUESTED:
        return <TouchableOpacity onPress={removeFriend}>
                <Text>Cancel Request</Text>
            </TouchableOpacity>
      case REQUEST:
      return <View><TouchableOpacity onPress={requestAccept}>
      ...
      default:
          return <TouchableOpacity onPress={sendRequest}>
